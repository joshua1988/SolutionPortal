...
<body>
<!-- <div class="row"> -->
	<form role="form" name="insertCModifyBoard" enctype="multipart/form-data">
		<div class="row">
	 		<div class="col-xs-7">
			 	<div class="input-group input-group-sm" style="padding-bottom: 5px;">
				  <span class="input-group-addon"><strong>제목</strong></span>
				  <input type="text" class="form-control input-sm" placeholder="제목" name="modify_title" class="modify_title" id="modify_title" value="${board.TITLE }">
				</div>
			</div>
			<div class="col-xs-5">
			<p style="font-size: 12px; padding-top: 5px;">분류: ${board.BOARD_NAME }</p>
			</div>
		</div>
	  ...
	  <div class="row">
		<div class="col-xs-12">
		    ...
		    <button type="button" class="btn btn-info btn-sm btn-block" onclick="javascript:cModifyBoard();">수정</button>
	    </div>
	  </div>
