...
public class ManagementController extends ExceptionControllerAdvice {
	...
	@Autowired ManagementService getManagementService;
    ...
    public ModelAndView getUserInfo( String userNo ) {
        ...
        ModelAndView mv = new ModelAndView();
        mv.setViewName( "mainPage" );
        mv.addObject( "page", "licenseManagement/userInform" );
...
//    		Writer writer,
		...
		logger.info("#### managerOfficePhon : " + managerOfficePhon);
		logger.info("#### managerCelPhon : " + managerCelPhon);
		logger.info("#### managerEmail : " + managerEmail);
		logger.info("#### oriCompanyId : " + oriUserNo);
...
//		writer.write("success");
    ...
    public String modifyCustomUser( HttpSession session,
        ...
        logger.info("#### session USER_NO : " + (String)session.getAttribute("USER_NO"));
		logger.info("#### userNo : " + userNo);
