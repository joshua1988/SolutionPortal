...
//    	var name = location.pathname.split('/');   // 로컬 URL
//    	sUploadURL= 'http://'+location.host+'/'+name[1]+'/PhotoUploadHTML5'; 	// 로컬 URL
...
//    	var sUploadURL= 'http://'+location.host+'/'+name[1]+'/PhotoUpload'; 	// 로컬 URL
 		var sUploadURL= '/PhotoUpload';  // 서버 URL
    	
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : sUploadURL,	//샘플 URL입니다.
...
//			opener.nhn.husky.PopUpManager.setCallback(window, 'SET_PHOTO', [oFileInfo]);
			...
			// 트위터 부트스트랩 css 적용 class="img-responsive" style="height: auto;"
			var editeFileInfo="";
			...
			opener.nhn.husky.PopUpManager.setCallback(window, 'PASTE_HTML', [editeFileInfo]);
		}
	}
